...
<!--Aquí empieza tabla--><table class="table table-striped">
  ...
  <tbody>
    <tr>
      <th scope="row">
      	<input type="text" value="0" name="cuno" id="c1" class="col-sm-3 form-control">
      </th>
      <td>
      	 <input type="text" placeholder="producto" name="puno" class="col-sm-12 form-control">
      </td>
      <td> <input type="text" value="0" name="tuno" id="t1" class="col-sm-3 form-control"> </td>
    </tr>
    <tr>
      <th scope="row">
      	<input type="text" value="0" id="c2" name="cdos" class="col-sm-3 form-control">
      </th>
      <td> <input type="text" placeholder="producto" name="pdos" class="col-sm-12 form-control"> </td>
      <td> <input type="text" value="0" name="tdos" id="t2" class="col-sm-3 form-control"> </td>
    </tr>
    <tr>
      <th scope="row">
      	<input type="text" value="0" id="c3" name="ctres" class="col-sm-3 form-control">
      </th>
      <td> <input type="text"  placeholder="producto" name="ptres" class="col-sm-12 form-control"> </td>
      <td> <input type="text" value="0" id="t3" name="ttres" class="col-sm-3 form-control"> </td>      
    </tr>
     <tr>
      
      <td> <input type="text" placeholder="abono" id="abono" name="abono" class="col-sm-3 form-control"> </td>
      <td> <input type="text" placeholder="saldo" id="saldo" name="saldo" class="col-sm-3 form-control"> </td>      
    </tr>
